...
def show_start(): #показ стартовой формы
    ...
    next_btn=Button(frm,pady=3,bd=5,text='Начать тестирование', font='Arial 20',bg=bg4,fg=fg6,width=20, command=start).pack()
    end_btn=Button(frm,pady=3,bd=5,text='Выход', width=20,font='Arial 20', bg=bg5,fg=fg6,command=end2).pack()
...
def show_form_str(): #показ формы строкового ответа
    ...
    next_btn=Button(frm,bd=5,text='Отправить ответ', font='Arial 20', command=send_str,bg=bg4,fg=fg6,width=20).pack()
    end_btn=Button(frm,bd=5,text='Выход', font='Arial 20', command=end,bg=bg5,fg=fg6,width=20).pack()
    rsp_text.set('')
...
def show_form_num(): #показ формы числового ответа
    ...
    next_btn=Button(frm,bd=5,text='Отправить ответ', bg=bg4,fg=fg6,font='Arial 20',width=20, command=send_num).pack()
    end_btn=Button(frm,bd=5,text='Выход', bg=bg5,fg=fg6,font='Arial 20', width=20,command=end).pack()
    rsp_text.set('')
...
def show_form_and(): #показ формы  ответа типа And
    ...
    next_btn=Button(frm,bd=5,bg=bg4,fg=fg6,text='Отправить ответ', font='Arial 20', command=send_and,width=20).pack()
    end_btn=Button(frm,bd=5,bg=bg5,fg=fg6,text='Выход', font='Arial 20', command=end,width=20).pack()
...
def show_form_or():  #показ формы  ответа типа Or
    ...
    next_btn=Button(frm,bd=5,bg=bg4,fg=fg6,text='Отправить ответ', font='Arial 20',width=20, command=send_or).pack()
    end_btn=Button(frm,bd=5,bg=bg5,fg=fg6,text='Выход', font='Arial 20',width=20, command=end).pack()
...
def show_form_end():  #показ формы  результата
    ...
    #кнопки
    start_btn=Button(frm,bd=5,bg=bg4,fg=fg6,text='Повторить тестирование',width=20, font='Arial 20', command=start_again).pack()
    reapeat_btn=Button(frm,bd=5,bg=bg6,fg=fg6,text='Новый пользователь', width=20,font='Arial 20', command=new_user).pack()
    end_btn=Button(frm,bd=5,bg=bg5,fg=fg6,text='Выход', font='Arial 20', command=end2,width=20).pack()
