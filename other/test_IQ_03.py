...
# ещё нужно сделать: 1. - сделать неактивными кнопки с клавы Enter F9 и Esc когда они не отображаются
# 		     2. + проблема с именами набранными кириллицей
#		     3. - по "закончить" - без сохранения?
...
def next_page(event=1):
    global ball,page,name,user_name,num,word,test_time,saved_results
    page=page+1
    if page==1 and user_name.get()=='':
        ...
        pr_bar1.place(x=200, y=400, width=90, height=30)
        pr_bar2.place(x=300, y=400, width=90, height=30)
        pr_bar3.place(x=400, y=400, width=90, height=30)
        pr_bar4.place(x=500, y=400, width=90, height=30)
        pr_bar1.configure(fg=osn_color)
        ...
        page2_homes.place(x=125, y=190, width=165, height=200)
        pr_bar1.place(x=200, y=400, width=90, height=30)
        pr_bar2.place(x=300, y=400, width=90, height=30)
        pr_bar3.place(x=400, y=400, width=90, height=30)
        pr_bar4.place(x=500, y=400, width=90, height=30)
        pr_bar1.configure(fg='#eeeeee')
        pr_bar2.configure(fg=osn_color)
    elif page==3:
        ...
        pr_bar3.place(x=400, y=400, width=90, height=30)
        pr_bar4.place(x=500, y=400, width=90, height=30)
        pr_bar2.configure(fg='#eeeeee')
        pr_bar3.configure(fg=osn_color)
    elif page==4:
        rad_btn=var.get()
        if rad_btn==1:
            ball=ball+1             # ball
        ...
        rad3.place_forget()
        rad4.place_forget()
        che1.place(x=215, y=210, width=155, height=30)
        che2.place(x=215, y=240, width=155, height=30)
        che3.place(x=215, y=270, width=155, height=30)
        che4.place(x=215, y=300, width=155, height=30)
        che5.place(x=215, y=330, width=155, height=30)
        che6.place(x=215, y=360, width=155, height=30)
        pr_bar1.place(x=200, y=400, width=90, height=30)
        pr_bar2.place(x=300, y=400, width=90, height=30)
        pr_bar3.place(x=400, y=400, width=90, height=30)
        pr_bar4.place(x=500, y=400, width=90, height=30)
        pr_bar3.configure(fg='#eeeeee')
        pr_bar4.configure(fg=osn_color)
    elif page==5:
        ...
        text_result.insert(1.0,'Имя тестируемого: '+name.encode('utf8')+'\nВы набрали '+str(ball)+' баллов\nМаксимум баллов 4\nВаша оценка - '+ocenka+'\nВы отвечали на тест '+str(test_time)+' секунд')
        text_result.place(x=80, y=170, width=450, height=140)
        #tegs
        text_result.tag_add('coler','1.17','1.end')
        text_result.tag_add('coler','2.11','2.end')
        text_result.tag_add('coler','3.16','3.end')
        text_result.tag_add('coler','4.14','4.end')
        text_result.tag_add('coler','5.20','5.end')
        text_result.tag_config('coler',foreground=osn_color)
        #
        saved_results=False
        ...
        pr_bar1.place_forget()
        pr_bar2.place_forget()
        pr_bar3.place_forget()
        pr_bar4.place_forget()
        pr_bar4.configure(fg='#eeeeee')
    else:
        page=0
        ball=0
...
def save_results(event=1):
    global name, ocenka, ball, test_time,saved_results
    saved_results=True
...
def close_win(event=1):
    if not saved_results:
        if tkMessageBox.askokcancel("Напоминание","Вы забыли сохранить результат\nOK - выйти без сохранения"):
            root.destroy()
    else:
        root.destroy()
...
# Текстовые лэйблы
text_zagolovok=Label(root,text='Тест на сообразительность №1',fg=osn_color,bg='#cccccc',font=('Arial', 30, 'bold'))
...
text_result=Text(root,fg='#666666',bg='#eeeeee',font="Arial 18",borderwidth=0)
...
# Прогрессбар
pr_bar1=Label(root,text='1',fg='#eeeeee',bg='#cccccc',font=('Arial', 18, 'bold'))
pr_bar2=Label(root,text='2',fg='#eeeeee',bg='#cccccc',font=('Arial', 18, 'bold'))
pr_bar3=Label(root,text='3',fg='#eeeeee',bg='#cccccc',font=('Arial', 18, 'bold'))
pr_bar4=Label(root,text='4',fg='#eeeeee',bg='#cccccc',font=('Arial', 18, 'bold'))
#pr_bar1.place(x=200, y=400, width=90, height=30)
#pr_bar2.place(x=300, y=400, width=90, height=30)
#pr_bar3.place(x=400, y=400, width=90, height=30)
#pr_bar4.place(x=500, y=400, width=90, height=30)
...
btn_snova=Button(root, text='Ещё раз! (Enter)',bg='#cccccc',command=next_page)
btn_save=Button(root, text='Сохранить результат (F9)',bg='#cccccc',command=save_results)
...
root.bind("<KeyPress-F9>",save_results)
